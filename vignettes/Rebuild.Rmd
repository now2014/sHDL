...
* For GWAS summary statistics with **severe missing** data, the heritability may be severely underestimated and the efficiency might be lost.
* This rebuilding process does not resolve the mismatch of **cross-ancestry** LD structures.

## Example

Suppose you have went through [this tutorial](https://now2014.github.io/sHDL/articles/Example.html) and 
