...
#'
#' The function maximizes the log likelihood to infer the heritability enrichment fold.
#'
...
#' @param lwr Lower bounds for the parameters.
#' @param upr Upper bounds for the parameters.
...
sHDL.optim <- function(
  ...
  message("Optimization done in ", round(time, 3), " seconds.\n")
